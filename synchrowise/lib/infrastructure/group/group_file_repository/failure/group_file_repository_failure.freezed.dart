...
part of 'group_file_repository_failure.dart';
...
/// @nodoc
class _$GroupFileRepositoryFailureTearOff {
  const _$GroupFileRepositoryFailureTearOff();
...
/// @nodoc
const $GroupFileRepositoryFailure = _$GroupFileRepositoryFailureTearOff();

/// @nodoc
mixin _$GroupFileRepositoryFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $GroupFileRepositoryFailureCopyWith<$Res> {
  factory $GroupFileRepositoryFailureCopyWith(GroupFileRepositoryFailure value,
          $Res Function(GroupFileRepositoryFailure) then) =
      _$GroupFileRepositoryFailureCopyWithImpl<$Res>;
}

/// @nodoc
class _$GroupFileRepositoryFailureCopyWithImpl<$Res>
    implements $GroupFileRepositoryFailureCopyWith<$Res> {
  _$GroupFileRepositoryFailureCopyWithImpl(this._value, this._then);

  final GroupFileRepositoryFailure _value;
  // ignore: unused_field
  final $Res Function(GroupFileRepositoryFailure) _then;
}
...
class __$ConnectionFailureCopyWithImpl<$Res>
    extends _$GroupFileRepositoryFailureCopyWithImpl<$Res>
...
class _$_ConnectionFailure implements _ConnectionFailure {
  ...
  @override
  String toString() {
    return 'GroupFileRepositoryFailure.connection()';
  }
...
abstract class _ConnectionFailure
    implements GroupFileRepositoryFailure, ConnectionSynchrowiseFailure {
...
class _$_ServerFailure implements _ServerFailure {
  ...
  @override
  String toString() {
    return 'GroupFileRepositoryFailure.server(statusCode: $statusCode, message: $message)';
  }
...
abstract class _ServerFailure
    implements GroupFileRepositoryFailure, ServerSynchrowiseFailure {
...
class _$_UnknownFailure implements _UnknownFailure {
  ...
  @override
  String toString() {
    return 'GroupFileRepositoryFailure.unknown(message: $message)';
  }
...
abstract class _UnknownFailure
    implements GroupFileRepositoryFailure, UnknownSynchrowiseFailure {
